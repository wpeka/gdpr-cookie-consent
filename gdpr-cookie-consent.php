 ...
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cookie Consent dev
...
define( 'GDPR_COOKIE_CONSENT_SETTINGS_VENDOR_CONSENT', 'vendorconsent' );
define( 'GDPR_COOKIE_CONSENT_SETTINGS_VENDOR_LEGINT', 'vendorlegint' );
