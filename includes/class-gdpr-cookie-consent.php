...
class Gdpr_Cookie_Consent {
	...
	public static function gdpr_get_json_settings() {
		...
		$slim_settings  = array(
			...
			'button_decline_button_hover'          => '#ffffff' === $settings['button_decline_button_color'] ? ( self::gdpr_su_hex_shift( $settings['button_decline_button_color'], 'down', 5 ) ) : ( self::gdpr_su_hex_shift( $settings['button_decline_button_color'], 'down', 20 ) ),
			...
			'button_settings_button_hover'         => '#ffffff' === $settings['button_settings_button_color'] ? ( self::gdpr_su_hex_shift( $settings['button_settings_button_color'], 'down', 5 ) ) : ( self::gdpr_su_hex_shift( $settings['button_settings_button_color'], 'down', 20 ) ),
