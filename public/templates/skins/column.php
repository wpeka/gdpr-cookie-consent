...
if ( ! empty( $the_options['gdpr_notify'] ) ) {
	...
	<?php
		...
		<p class="gdpr"><?php echo $the_options['is_iabtcf_on'] ? $cookie_data['dash_notify_message_iabtcf']: strip_tags(__( $cookie_data['dash_notify_message']), '<a><br><em><strong><span><p><i><img><b><div><label>' ); ?>
		<?php
	...
	<div class="gdpr_messagebar_content">
		...
		if($ab_options['ab_testing_enabled'] === "false" || $ab_options['ab_testing_enabled'] === false){
			...
			?>
			<p class="lgpd"><?php echo strip_tags( $cookie_data['dash_notify_message_lgpd'], '<a><br><em><strong><span><p><i><img><b><div><label>' ); ?></p>
			<?php
			if ( ! empty( $the_options['button_readmore_is_on'] ) ) {
				?>
				<p>
