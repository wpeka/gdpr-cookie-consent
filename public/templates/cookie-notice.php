...
//styling for banner
	...
	$accept_all_button = $template_object['accept_all_button'] ?? [];
	$accept_all_style_attr .= "min-width: " . ($accept_all_button['min-width'] ?? '') . ";";
	$accept_all_style_attr .= "display: " . ($accept_all_button['display'] ?? '') . ";";
	$accept_all_style_attr .= "justify-content: " . ($accept_all_button['justify-content'] ?? '') . ";";
	$accept_all_style_attr .= "align-items: " . ($accept_all_button['align-items'] ?? '') . ";";
	$accept_all_style_attr .= "text-align: " . ($accept_all_button['text-align'] ?? '') . ";";
	...
	$settings_button = $template_object['settings_button'] ?? [];
	$settings_style_attr .= "min-width: " . ($settings_button['min-width'] ?? '') . ";";
	$settings_style_attr .= "display: " . ($settings_button['display'] ?? '') . ";";
	$settings_style_attr .= "justify-content: " . ($settings_button['justify-content'] ?? '') . ";";
	$settings_style_attr .= "align-items: " . ($settings_button['align-items'] ?? '') . ";";
	$settings_style_attr .= "text-align: " . ($settings_button['text-align'] ?? '') . ";";
	...
	$decline_button = $template_object['decline_button'] ?? [];
	$decline_style_attr .= "min-width: " . ($decline_button['min-width'] ?? '') . ";";
	$decline_style_attr .= "display: " . ($decline_button['display'] ?? '') . ";";
	$decline_style_attr .= "justify-content: " . ($decline_button['justify-content'] ?? '') . ";";
	$decline_style_attr .= "align-items: " . ($decline_button['align-items'] ?? '') . ";";
	$decline_style_attr .= "text-align: " . ($decline_button['text-align'] ?? '') . ";";
...
<div id="<?php echo esc_html( $the_options['container_id'] ); ?>" class="<?php echo esc_html( $the_options['container_class'] ); ?> <?php echo esc_html( $the_options['theme_class'] ); ?>"  style="<?php echo esc_attr($notice_container_styles); ?>">	
	...
	<div class="<?php echo esc_attr($template_object['static-settings']['layout'] ?? '');?>">
			...
			<div style="display: flex; flex-direction: column; gap: 10px;">
				...
				<p  class = "<?php if($the_options['cookie_usage_for'] === 'both') echo 'gdpr';?>">
					<?php if ( $the_options['cookie_usage_for'] === 'gdpr'  || $the_options['cookie_usage_for'] === 'both' ) : ?>
						 <span><?php echo $the_options['is_iabtcf_on'] ? ($cookie_data['dash_notify_message_iabtcf'] ?? '') : (isset($cookie_data['dash_notify_message']) ? strip_tags(__($cookie_data['dash_notify_message']), '<a><br><em><strong><span><p><i><img><b><div><label>') : ''); ?></span>
		...
		<?php if ( $the_options['cookie_usage_for'] !== 'ccpa' ) : ?>
				<?php
					$static_settings = $template_object['static-settings'] ?? [];
				?>
