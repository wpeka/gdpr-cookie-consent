...
//styling for banner
	...
	if ($the_options['button_readmore_as_button' . $suffix] === 'true' || $the_options['button_readmore_as_button' . $suffix] === true || $the_options['button_readmore_as_button' . $suffix] === 1) {
		$padding_key = 'button_' . $the_options['button_readmore_button_size' . $suffix] . '_padding';
...
<div id="<?php echo esc_html( $the_options['container_id'] ); ?>" class="<?php echo esc_html( $the_options['container_class'] ); ?> <?php echo esc_html( $the_options['theme_class'] ); ?>"  style="<?php echo esc_attr($notice_container_styles); ?>">	
	...
	<div class="<?php echo esc_attr($template_object['static-settings']['layout']);?>">
		...
		<p  class = "<?php if($the_options['cookie_usage_for'] === 'both') echo 'gdpr';?>">
			...
			<?php elseif( $the_options['cookie_usage_for'] !== 'ccpa' &&  ! empty( $the_options['button_readmore_is_on' . $suffix] ) ) : ?>
				...
				<?php if ( ! empty( $the_options['button_readmore_new_win' . $suffix] ) ) { ?>
					target="_blank"
				<?php } ?>
				>
