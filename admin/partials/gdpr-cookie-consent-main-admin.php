...
<div id="gdpr-cookie-consent-main-admin-structure" class="gdpr-cookie-consent-main-admin-structure">
	<div id="gdpr-cookie-consent-main-admin-header" class="gdpr-cookie-consent-main-admin-header">
		...
		<div class="gdpr-cookie-consent-connect-api-container">
			...
			<h2>
				<?php echo esc_html( 'Connect your website to WP Cookie Consent' ); ?>
			</h2>
			<p><?php echo esc_html( 'Sign up for a free account to integrate seamlessly with the WP Cookie Consent server. Once connected, gain full control over your settings and unlock advanced features:' ); ?></p>
			<p>
				<span><img src="<?php echo esc_url( GDPR_COOKIE_CONSENT_PLUGIN_URL ) . 'admin/images/bullet_point.png'; ?>" alt="<?php echo esc_attr( 'API Connection Success Mark' ); ?>"></span> <strong><?php echo esc_html( 'Cookie Scanner:' ); ?></strong> <?php echo esc_html( 'Identify cookies on your website and automatically block them before user consent (essential for legal compliance).' ); ?>
			</p>
			<p>
				<span><img src="<?php echo esc_url( GDPR_COOKIE_CONSENT_PLUGIN_URL ) . 'admin/images/bullet_point.png'; ?>" alt="<?php echo esc_attr( 'API Connection Success Mark' ); ?>"></span> <strong><?php echo esc_html( 'Advanced Dashboard:' ); ?></strong> <?php echo esc_html( 'Unlock useful insights on user\'s consent data, cookie summary, and consent logs.' ); ?>
			</p>
			<p>
				<span><img src="<?php echo esc_url( GDPR_COOKIE_CONSENT_PLUGIN_URL ) . 'admin/images/bullet_point.png'; ?>" alt="<?php echo esc_attr( 'API Connection Success Mark' ); ?>"></span> <strong><?php echo esc_html( 'Geo-targeting:' ); ?></strong> <?php echo esc_html( 'Display or hide the GDPR cookie consent notice depending on the visitor’s location.' ); ?>
			</p>
		</div>
		<div class="gdpr-api-connection-btns">
			<button class="gdpr-start-auth"><?php echo esc_html( 'New? Create a free account' ); ?></button>
			<button class="api-connect-to-account-btn"><?php echo esc_html( 'Connect your existing account' ); ?></button>
		</div>
