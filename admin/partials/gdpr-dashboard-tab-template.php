...
wp_enqueue_style( 'gdpr-cookie-consent-dashboard' );
wp_enqueue_script( 'gdpr-cookie-consent-dashboard' );
wp_localize_script(
	'gdpr-cookie-consent-dashboard',
	'dashboard_options',
	array(
...
<div id="gdpr-cookie-consent-dashboard-page">
	<c-container class="gdpr-cookie-consent-dashboard-container gdpr-admin-dashaboard-template">
