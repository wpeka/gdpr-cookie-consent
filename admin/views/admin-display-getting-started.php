...
$pro_link = sprintf(
	...
	esc_url( 'https://club.wpeka.com/product/wp-gdpr-cookie-consent/?utm_source=gdpr&utm_medium=getting-started&utm_campaign=link&utm_content=pro-version' ),
	esc_html__( 'pro version', 'gdpr-cookie-consent' )
);
?>
