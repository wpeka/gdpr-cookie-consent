...
<div class="gdpr-cookie-consent-tab-content" data-id="<?php echo esc_attr( $target_id ); ?>">
	...
	<div class="gdpr_sub_tab_container">
		...
		<div class="gdpr_sub_tab_content" data-id="show-again-general">
			<p></p>
			<table class="form-table">
				<tr valign="top">
				...
				<tr valign="top">
					<th scope="row"><label for="show_again_margin_field"><?php esc_attr_e( 'Show Again Tab Margin (in px or %)', 'gdpr-cookie-consent' ); ?></label></th>
					<td>
						<input type="text" name="show_again_margin_field" value="<?php echo esc_html( stripslashes( $the_options['show_again_margin'] ) ); ?>" />
					</td>
				</tr>
				<tr valign="top">
		...
		<div class="gdpr_sub_tab_content" data-id="other-general">
			...
			<table class="form-table">
				...
				<tr valign="top" gdpr_frm_tgl-id="gdpr_auto_hide" gdpr_frm_tgl-val="true">
					...
					<td>
						<input type="text" name="auto_hide_delay_field" value="<?php echo esc_html( stripslashes( $the_options['auto_hide_delay'] ) ); ?>" />
				...
				<tr valign="top">
					...
					<td>
						<input type="radio" id="auto_scroll_field_yes" name="auto_scroll_field" class="styled gdpr_bar_on" value="true" <?php echo ( true === $the_options['auto_scroll'] ) ? ' checked="checked"' : ''; ?> /><?php esc_attr_e( 'On', 'gdpr-cookie-consent' ); ?>
						<input type="radio" id="auto_scroll_field_no" name="auto_scroll_field" class="styled" value="false" <?php echo ( false === $the_options['auto_scroll'] ) ? ' checked="checked" ' : ''; ?> /><?php esc_attr_e( 'Off', 'gdpr-cookie-consent' ); ?>
