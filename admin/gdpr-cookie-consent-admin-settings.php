					...
					<c-tab title="<?php esc_attr_e('Design', 'gdpr-cookie-consent'); ?>" href="#gdpr_design">
						...
						<c-card v-show="is_gdpr || is_eprivacy">
							...
							<c-card-body>
								...
								<c-modal title="Accept Button" :show.sync="accept_button_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
						...
						<c-card v-show="is_gdpr || is_eprivacy">
							...
							<c-card-body>
								...
								<c-modal title="Accept All Button" :show.sync="accept_all_button_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
									<c-row class="gdpr-label-row">
										<c-col class="col-sm-6">
											<label><?php esc_attr_e('Text', 'gdpr-cookie-consent'); ?></label>
										</c-col>
						...
						<c-card v-show="is_gdpr || is_eprivacy">
							...
							<c-card-body>
								...
								<c-modal title="Decline Button" :show.sync="decline_button_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
									<c-row class="gdpr-label-row">
										<c-col class="col-sm-6">
											<label><?php esc_attr_e('Text', 'gdpr-cookie-consent'); ?></label>
										</c-col>
						...
						<c-card v-show="is_gdpr">
							...
							<c-card-body>
								...
								<c-modal title="Settings Button" :show.sync="settings_button_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
									<c-row class="gdpr-label-row">
										<c-col class="col-sm-6">
											<label><?php esc_attr_e('Text', 'gdpr-cookie-consent'); ?></label>
										</c-col>
						...
						<c-card v-show="is_ccpa">
							...
							<c-card-body>
								...
								<c-modal title="Confirm Button" :show.sync="confirm_button_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
									<c-row class="gdpr-label-row">
										<c-col class="col-sm-6">
											<label><?php esc_attr_e('Text', 'gdpr-cookie-consent'); ?></label>
										</c-col>
						...
						<c-card v-show="is_ccpa">
							...
							<c-card-body>
								...
								<c-modal title="Cancel Button" :show.sync="cancel_button_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
									<c-row class="gdpr-label-row">
										<c-col class="col-sm-6">
											<label><?php esc_attr_e('Text', 'gdpr-cookie-consent'); ?></label>
										</c-col>
						...
						<c-card v-show="is_ccpa">
							...
							<c-card-body>
								...
								<c-modal title="Opt-out Link" :show.sync="opt_out_link_popup" size="lg" :close-on-backdrop="closeOnBackdrop" :centered="centered">
									<c-row class="gdpr-label-row">
										<c-col class="col-sm-6">
											<label><?php esc_attr_e('Text', 'gdpr-cookie-consent'); ?></label>
										</c-col>
