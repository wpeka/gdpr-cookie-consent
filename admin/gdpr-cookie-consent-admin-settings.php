					...
					<c-card class="desgin_card">
						<c-card-body>
							...
							<c-row>
								...
								<c-input class="gdpr-slider-input opacity-slider"type="number" min="0" max="1" step="0.1" name="gdpr-cookie-bar-opacity" v-model="cookie_bar_opacity"></c-input>
								</c-col>
							</c-row>
							<c-row>
								<c-col class="col-sm-4"><label><?php esc_attr_e( 'Text Color', 'gdpr-cookie-consent' ); ?></label></c-col>
						...
						<c-card-body v-show="active_test_banner_tab === 1">
								<c-card-body >
									...
									<c-row>
										...
										<c-input class="gdpr-slider-input opacity-slider"type="number" min="0" max="1" step="0.1" name="gdpr-cookie-bar-opacity1" v-model="cookie_bar_opacity1"></c-input>
										</c-col>
									</c-row>
									<c-row>
										<c-col class="col-sm-4"><label><?php esc_attr_e( 'Text Color', 'gdpr-cookie-consent' ); ?></label></c-col>
						...
						<c-card-body v-show="active_test_banner_tab === 2">
								<c-card-body >
									...
									<c-row>
										...
										<c-input class="gdpr-slider-input opacity-slider"type="number" min="0" max="1" step="0.1"  name="gdpr-cookie-bar-opacity2" v-model="cookie_bar_opacity2"></c-input>
										</c-col>
									</c-row>
									<c-row>
										<c-col class="col-sm-4"><label><?php esc_attr_e( 'Text Color', 'gdpr-cookie-consent' ); ?></label></c-col>
