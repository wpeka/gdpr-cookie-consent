					...
					<c-card class="configuration_card">
						<c-card-body>
							...
							if ( version_compare( $plugin_version, '2.5.2', '<=' ) ) {
								...
								<?php } ?>
								<c-row>
									<c-col class="col-sm-4 relative"><label><?php esc_attr_e( 'Auto Generated Banner', 'gdpr-cookie-consent' ); ?></label>
									</c-col>
									<c-col class="col-sm-8">
									<c-switch v-bind="labelIcon" v-model="auto_generated_banner" id="gdpr-cookie-consent-auto_generated_banner" variant="3d"  color="success" :checked="auto_generated_banner" v-on:update:checked="onSwitchAutoGeneratedBanner"></c-switch>
										<input type="hidden" name="gcc-auto-generated-banner" v-model="auto_generated_banner">
									</c-col>
								</c-row>
							<!-- Template screens -->
