								...
								<div v-show="(show_revoke_card || is_lgpd) && button_readmore_is_on">
									<c-row v-show="button_readmore_as_button">
										...
										<c-col class="col-sm-8 gdpr-color-pick" >
											...
											<label for="gdpr-readmore-button-color" class="screen-reader-text"><?php esc_attr_e('GCC readmore button color'); ?></label>
					...
					<c-card class=" desgin_card" v-show="!ab_testing_enabled && gdpr_policy == 'both'">
						...
						<c-card-body >
								...
								<c-card-body>
									...
									<c-row>
										<c-col class="col-sm-6">
											<label for="button_accept_text_field1" class="screen-reader-text"><?php esc_attr_e('button accept text field1'); ?></label>
										...
										<c-col class="col-sm-6 gdpr-color-pick">
											...
											<label for="gdpr-cookie-accept-text-color1" class="screen-reader-text"><?php esc_attr_e('gdpr cookie accept text color1'); ?></label>
									...
									<c-row v-show="accept_action1!='#cookie_action_close_header'">
										<c-col class="col-sm-6">
											<label for="gdpr-cookie-accept-url1" class="screen-reader-text"><?php esc_attr_e('gdpr cookie accept url1'); ?></label>
				...
				<c-card  v-show="ab_testing_enabled  && gdpr_policy != 'both'"class=" desgin_card">
					...
					<c-card-body v-show="active_test_banner_tab === 1">
						...
						<c-card-body>
							...
							<c-row>
								<c-col class="col-sm-6">
									<label for="button_accept_text_field1" class="screen-reader-text"><?php esc_attr_e('button_accept_text_field1','gdpr-cookie-consent'); ?></label>
									<c-input id="button_accept_text_field1" name="button_accept_text_field1" v-model="accept_text1"></c-input>
								</c-col>
								<c-col class="col-sm-6 gdpr-color-pick">
									<c-input class="gdpr-color-input" type="text" v-model="accept_text_color1"></c-input>
