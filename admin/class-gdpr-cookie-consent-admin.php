...
class Gdpr_Cookie_Consent_Admin {
	...
	public function add_tabs() {
		...
		$screen->set_help_sidebar(
			'<p><strong>' . __( 'For more information:', 'gdpr-cookie-consent' ) . '</strong></p>' .
					'<p><a href="https://club.wpeka.com/product/wp-gdpr-cookie-consent/?utm_source=plugin&utm_medium=gdpr&utm_campaign=top-help-bar&utm_content=about-gdpr" target="_blank">' . __( 'About GDPR Cookie Consent', 'gdpr-cookie-consent' ) . '</a></p>' .
	...
	public function gdpr_cookie_consent_ajax_save_settings() {
		if ( isset( $_POST['gcc_settings_form_nonce'] ) ) {
			...
			// The below phpcs ignore comments have been removed and santitisation checks have been added.
			$the_options['header_scripts']                       = isset( $_POST['gcc-header-scripts'] ) ? sanitize_text_field(wp_unslash( $_POST['gcc-header-scripts'] )) : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			$the_options['body_scripts']                         = isset( $_POST['gcc-body-scripts'] ) ? sanitize_text_field(wp_unslash( $_POST['gcc-body-scripts'] )) : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			$the_options['footer_scripts']                       = isset( $_POST['gcc-footer-scripts'] ) ? sanitize_text_field(wp_unslash( $_POST['gcc-footer-scripts'] )) : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
