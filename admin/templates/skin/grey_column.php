	...
	<div class="gdprmodal-dialog gdprmodal-dialog-centered">
		...
		<div class="gdprmodal-content">
					...
					<div class="gdpr-groups-container">
						...
						<ul class="gdpr-iab-navbar">
							...
							<li class="gdpr-iab-navbar-item" id="gdprIABTabVendors"><button class="gdpr-iab-navbar-button">Vendors</button></li>
										...
										<div class="always-active" style="color: rgb(225, 68, 105);">Always Active</div>
										<input id="gdpr_messagebar_body_button_necessary" type="hidden" name="gdpr_messagebar_body_button_necessary" value="necessary">
									</div>
																		<div class="gdpr-column gdpr-category-toggle grey_column">
									<div class="gdpr-columns" style="background-color: rgb(224, 224, 224);">
			...
			<div class="gdprmodal-footer">
								<button id="cookie_action_save" type="button" class="gdpr_action_button btn" data-gdpr_action="accept" data-dismiss="gdprmodal" style="color: rgb(255, 255, 255); background-color: rgb(225, 68, 105); border: 0px none rgb(225, 68, 105); border-radius: 0px;">Save And Accept</button>
			</div>
		</div>
	</div>
</div>
