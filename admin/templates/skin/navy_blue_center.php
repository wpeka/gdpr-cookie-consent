	...
	<div class="gdprmodal-dialog gdprmodal-dialog-centered">
		...
		<div class="gdprmodal-content">
			...
			<div class="gdprmodal-footer">
								<button id="cookie_action_save" type="button" class="gdpr_action_button btn" data-gdpr_action="accept" data-dismiss="gdprmodal" style="color: rgb(229, 229, 229); background-color: rgb(54, 158, 227); border: 1px solid rgb(54, 158, 227); border-radius: 0px;">Save And Accept</button>
			</div>
		</div>
	</div>
</div>
