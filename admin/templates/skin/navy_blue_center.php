...
?>
<div class="gdpr_messagebar_detail layout-default navy_blue_center theme-twentytwentyfour hide-popup">
                           ...
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    ...
                                    <input id="gdpr_messagebar_body_button_marketing_navy_blue_center" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_marketing_navy_blue_center" value="marketing">
                                    <label for="gdpr_messagebar_body_button_marketing_navy_blue_center">
                        ...
                        <li class="category-item">
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                    <input id="gdpr_messagebar_body_button_analytics_navy_blue_center" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_analytics_navy_blue_center" value="analytics">
                                    <label for="gdpr_messagebar_body_button_analytics_navy_blue_center">
                        ...
                        <li class="category-item">
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                    <input id="gdpr_messagebar_body_button_preferences_navy_blue_center" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_preferences_navy_blue_center" value="preferences">
                                    <label for="gdpr_messagebar_body_button_preferences_navy_blue_center">
                        ...
                        <li class="category-item">
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                    <input id="gdpr_messagebar_body_button_unclassified_navy_blue_center" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_unclassified_navy_blue_center" value="unclassified">
                                    <label for="gdpr_messagebar_body_button_unclassified_navy_blue_center">
                                 ...
                                 <div class="checkbox">
                                    ...
                                    <input 
                                       ...
                                       <?php
                                          ...
                                          ?>
                                       id="gdpr_messagebar_body_button_navy_blue_center_<?php echo esc_html($classnames);?>" class="<?php echo esc_html($classnames);?>-all-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_navy_blue_center_<?php echo esc_html($classnames);?>">
                                    <label for="gdpr_messagebar_body_button_navy_blue_center_<?php echo esc_html($classnames);?>">
                                                ...
                                                <div class="checkbox">
                                                   ...
                                                   <input 
                                                      ...
                                                      <?php
                                                         ...
                                                         ?>
                                                      id="gdpr_messagebar_body_button_navy_blue_center_consent_<?php echo esc_html($classnames)?>_<?php echo esc_html($value->id); ?>"
                                                      ...
                                                      type="checkbox" 
                                                      name="gdpr_messagebar_body_button_navy_blue_center_consent_<?php echo esc_html($classnames)?>_<?php echo esc_html($value->id); ?>"
                                                      value=<?php echo esc_html( $value->id ); ?> >
                                                   <label for="gdpr_messagebar_body_button_navy_blue_center_consent_<?php echo esc_html($classnames)?>_<?php echo esc_html($value->id); ?>">
                                                   <span class="label-text"><?php echo esc_html( $value->id ); ?></span>
                                                   </label>
                                                   <!-- DYNAMICALLY GENERATE Input ID  -->
                                                </div>
                                 ...
                                 <div class="checkbox">
                                    ...
                                    <input 
                                       ...
                                       <?php
                                          ...
                                          ?>
                                       id="gdpr_messagebar_body_button_navy_blue_center_vendor-all" 
                                       class="vendor-all-switch-handler" 
                                       type="checkbox" 
                                       name="gdpr_messagebar_body_button_navy_blue_center_vendor-all" 
                                       value="<?php echo esc_html( is_array($data->allvendors) ? implode(',', $data->allvendors) : $data->allvendors ); ?>">
                                    <label for="gdpr_messagebar_body_button_navy_blue_center_vendor-all">
                                    <span class="label-text"></span>
                                    </label>
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                 </div>
                                                ...
                                                <div class="checkbox">
                                                   ...
                                                   <input 
                                                      ...
                                                      <?php
                                                         ...
                                                         ?>
                                                      id="gdpr_messagebar_body_button_navy_blue_center_consent_vendor_<?php echo esc_html($vendor->id);?>" 
                                                      class="vendor-switch-handler <?php echo esc_html("consent-switch", "gdpr-cookie-consent");?> <?php echo esc_html($vendor->id);?>" 
                                                      type="checkbox" 
                                                      name="gdpr_messagebar_body_button_navy_blue_center_consent_vendor_<?php echo esc_html($vendor->id);?>" 
                                                      value=<?php echo esc_html( $vendor->id ); ?>>
                                                   <label for="gdpr_messagebar_body_button_navy_blue_center_consent_vendor_<?php echo esc_html($vendor->id);?>">
                                                   <span class="label-text"><?php echo esc_html( $vendor->id ); ?></span>
                                                   </label>
                                                   <!-- DYNAMICALLY GENERATE Input ID  -->
                                                </div>
												...
												<div class="toggle-group">
													<div class="toggle">
														<div class="checkbox">
															...
															?>
															id="gdpr_messagebar_body_button_navy_blue_center_gacm-vendor-all" 
															class="gacm-vendor-all-switch-handler" 
															type="checkbox" 
															name="gdpr_messagebar_body_button_navy_blue_center_gacm-vendor-all" 
															value=<?php echo esc_html( $data->allvendors ); ?>>
															<label for="gdpr_messagebar_body_button_navy_blue_center_gacm-vendor-all">
																<span class="label-text"></span>
															</label>
															<!-- DYNAMICALLY GENERATE Input ID  -->
														</div>
																						...
																						<div class="vendor-consent-switch-wrapper">
																							...
																							<div class="toggle">
																								<div class="checkbox">
																									...
																									?>
																									id="gdpr_messagebar_body_button_navy_blue_center_consent_vendor_<?php echo esc_html($vendor[0]);?>" 
																									class="vendor-switch-handler <?php echo esc_html("consent-switch", "gdpr-cookie-consent");?> <?php echo esc_html($vendor[0]);?>" 
																									type="checkbox" 
																									name="gdpr_messagebar_body_button_navy_blue_center_consent_vendor_<?php echo esc_html($vendor[0]);?>" 
																									value=<?php echo esc_html( $vendor[0]); ?>>
																									<label for="gdpr_messagebar_body_button_navy_blue_center_consent_vendor_<?php echo esc_html($vendor[0]);?>">
