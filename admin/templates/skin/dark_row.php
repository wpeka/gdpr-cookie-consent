	...
	<div class="gdprmodal-dialog gdprmodal-dialog-centered">
		...
		<div class="gdprmodal-content">
                           ...
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    ...
                                    <input id="gdpr_messagebar_body_button_marketing_dark_row" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_marketing_dark_row" value="marketing">
                                    <label for="gdpr_messagebar_body_button_marketing_dark_row">
                        ...
                        <li class="category-item">
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                    <input id="gdpr_messagebar_body_button_analytics_dark_row" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_analytics_dark_row" value="analytics">
                                    <label for="gdpr_messagebar_body_button_analytics_dark_row">
                        ...
                        <li class="category-item">
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                    <input id="gdpr_messagebar_body_button_preferences_dark_row" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_preferences_dark_row" value="preferences">
                                    <label for="gdpr_messagebar_body_button_preferences_dark_row">
                        ...
                        <li class="category-item">
                           <div class="toggle-group">
                              <div class="toggle">
                                 <div class="checkbox">
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                    <input id="gdpr_messagebar_body_button_unclassified_dark_row" class="category-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_unclassified_dark_row" value="unclassified">
                                    <label for="gdpr_messagebar_body_button_unclassified_dark_row">
                                 ...
                                 <div class="checkbox">
                                    ...
                                    <input 
                                       ...
                                       <?php
                                          ...
                                          ?>
                                       id="gdpr_messagebar_body_button_dark_row_<?php echo esc_html($classnames);?>" class="<?php echo esc_html($classnames);?>-all-switch-handler" type="checkbox" name="gdpr_messagebar_body_button_dark_row_<?php echo esc_html($classnames);?>">
                                    <label for="gdpr_messagebar_body_button_dark_row_<?php echo esc_html($classnames);?>">
                                                ...
                                                <div class="checkbox">
                                                   ...
                                                   <input 
                                                      ...
                                                      <?php
                                                         ...
                                                         ?>
                                                      id="gdpr_messagebar_body_button_dark_row_consent_<?php echo esc_html($classnames)?>_<?php echo esc_html($value->id); ?>"
                                                      ...
                                                      type="checkbox" 
                                                      name="gdpr_messagebar_body_button_dark_row_consent_<?php echo esc_html($classnames)?>_<?php echo esc_html($value->id); ?>"
                                                      value=<?php echo esc_html( $value->id ); ?> >
                                                   <label for="gdpr_messagebar_body_button_dark_row_consent_<?php echo esc_html($classnames)?>_<?php echo esc_html($value->id); ?>">
                                                   <span class="label-text"><?php echo esc_html( $value->id ); ?></span>
                                                   </label>
                                                   <!-- DYNAMICALLY GENERATE Input ID  -->
                                                </div>
                                 ...
                                 <div class="checkbox">
                                    ...
                                    <input 
                                       ...
                                       <?php
                                          ...
                                          ?>
                                       id="gdpr_messagebar_body_button_dark_row_vendor-all" 
                                       class="vendor-all-switch-handler" 
                                       type="checkbox" 
                                       name="gdpr_messagebar_body_button_dark_row_vendor-all" 
                                       value="<?php echo esc_html( is_array($data->allvendors) ? implode(',', $data->allvendors) : $data->allvendors ); ?>">
                                    <label for="gdpr_messagebar_body_button_dark_row_vendor-all">
                                    <span class="label-text"></span>
                                    </label>
                                    <!-- DYNAMICALLY GENERATE Input ID  -->
                                 </div>
                                                ...
                                                <div class="checkbox">
                                                   ...
                                                   <input 
                                                      ...
                                                      <?php
                                                         ...
                                                         ?>
                                                      id="gdpr_messagebar_body_button_dark_row_consent_vendor_<?php echo esc_html($vendor->id);?>" 
                                                      class="vendor-switch-handler <?php echo esc_html("consent-switch", "gdpr-cookie-consent");?> <?php echo esc_html($vendor->id);?>" 
                                                      type="checkbox" 
                                                      name="gdpr_messagebar_body_button_dark_row_consent_vendor_<?php echo esc_html($vendor->id);?>" 
                                                      value=<?php echo esc_html( $vendor->id ); ?>>
                                                   <label for="gdpr_messagebar_body_button_dark_row_consent_vendor_<?php echo esc_html($vendor->id);?>">
                                                   <span class="label-text"><?php echo esc_html( $vendor->id ); ?></span>
                                                   </label>
                                                   <!-- DYNAMICALLY GENERATE Input ID  -->
                                                </div>
												...
												<div class="toggle-group">
													<div class="toggle">
														<div class="checkbox">
															...
															?>
															id="gdpr_messagebar_body_button_dark_row_gacm-vendor-all" 
															class="gacm-vendor-all-switch-handler" 
															type="checkbox" 
															name="gdpr_messagebar_body_button_dark_row_gacm-vendor-all" 
															value=<?php echo esc_html( $data->allvendors ); ?>>
															<label for="gdpr_messagebar_body_button_dark_row_gacm-vendor-all">
																<span class="label-text"></span>
															</label>
															<!-- DYNAMICALLY GENERATE Input ID  -->
														</div>
																						...
																						<div class="vendor-consent-switch-wrapper">
																							...
																							<div class="toggle">
																								<div class="checkbox">
																									...
																									?>
																									id="gdpr_messagebar_body_button_dark_row_consent_vendor_<?php echo esc_html($vendor[0]);?>" 
																									class="vendor-switch-handler <?php echo esc_html("consent-switch", "gdpr-cookie-consent");?> <?php echo esc_html($vendor[0]);?>" 
																									type="checkbox" 
																									name="gdpr_messagebar_body_button_dark_row_consent_vendor_<?php echo esc_html($vendor[0]);?>" 
																									value=<?php echo esc_html( $vendor[0]); ?>>
																									<label for="gdpr_messagebar_body_button_dark_row_consent_vendor_<?php echo esc_html($vendor[0]);?>">
			...
			<div class="gdprmodal-footer">
								<button id="cookie_action_save" type="button" class="gdpr_action_button btn" data-gdpr_action="accept" data-dismiss="gdprmodal" style="color: rgb(255, 255, 255); background-color: rgb(102, 204, 102); border: 0px none rgb(222, 120, 52); border-radius: 0px;">Save And Accept</button>
			</div>
		</div>
	</div>
</div>
