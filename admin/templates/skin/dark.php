...
<div class="gdpr_messagebar_detail layout-default dark theme-twentytwentyfour hide-popup">
			<div class="gdprmodal gdprfade gdprshow" id="gdpr-gdprmodal" role="dialog" data-keyboard="false" data-backdrop="false" style="display: block;" aria-gdprmodal="true">
	<div class="gdprmodal-dialog gdprmodal-dialog-centered">
		...
		<div class="gdprmodal-content">
						...
						<ul class="category-group">
							<li class="category-item">
								<div class="gdpr-column gdpr-default-category-toggle">
									<div class="gdpr-columns active-group" tabindex="0" style="background-color: rgb(106, 142, 231);">
								...
								<div class="description-container">
									<div class="group-toggle">
										<h3 class="category-header" tabindex="0">About Cookies</h3>
															...
															<li class="category-item">
								<div class="gdpr-column gdpr-default-category-toggle  dark">
									<div class="gdpr-columns" style="background-color: rgb(58, 58, 58);">
								...
								<div class="description-container hide">
									<div class="group-toggle">
										<h3 class="category-header" tabindex="0">Necessary</h3>
												...
												<div class="always-active" style="color: rgb(106, 142, 231);">Always Active</div>
			...
			<div class="gdprmodal-footer">
								<button id="cookie_action_save" type="button" class="gdpr_action_button btn" data-gdpr_action="accept" data-dismiss="gdprmodal" style="color: rgb(255, 255, 255); background-color: rgb(106, 142, 231); border: 1px solid rgb(106, 142, 231); border-radius: 0px;">Save And Accept</button>
			</div>
		</div>
	</div>
</div>
