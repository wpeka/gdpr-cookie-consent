	...
	<div class="gdprmodal-dialog gdprmodal-dialog-centered">
		...
		<div class="gdprmodal-content">
						...
						<ul class="category-group">
							<li class="category-item">
								<div class="gdpr-column gdpr-default-category-toggle">
									<div class="gdpr-columns active-group" tabindex="0" style="background-color: rgb(54, 158, 227);">
								...
								<div class="description-container">
									<div class="group-toggle">
										<h3 class="category-header" tabindex="0">About Cookies</h3>
															...
															<li class="category-item">
								<div class="gdpr-column gdpr-default-category-toggle  navy_blue_square">
								...
								<div class="description-container hide">
									<div class="group-toggle">
										<h3 class="category-header" tabindex="0">Necessary</h3>
												...
												<div class="always-active" style="color: rgb(54, 158, 227);">Always Active</div>
			...
			<div class="gdprmodal-footer">
								<button id="cookie_action_save" type="button" class="gdpr_action_button btn" data-gdpr_action="accept" data-dismiss="gdprmodal" style="color: rgb(229, 229, 229); background-color: rgb(54, 158, 227); border: 0px rgb(54, 158, 227); border-radius: 0px;">Save And Accept</button>
			</div>
		</div>
	</div>
</div>
