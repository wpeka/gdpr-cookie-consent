# WPLP Cookie Consent ( for GDPR, CCPA & ePrivacy ) #
...
Welcome to the WPLP Cookie Consent repository on GitHub. Here you can browse the source, look at open issues and keep track of development.

If you are not a developer, please use the [WPLP Cookie Consent plugin](https://wordpress.org/plugins/gdpr-cookie-consent/) page on WordPress.org.

## Documentation
* [WPLP Cookie Consent Documentation](https://wplegalpages.com/docs/wp-cookie-consent/)
...
* The [WPeka Club Premium Support My-Account Area](https://wplegalpages.com/app/) for customers who have purchased WPEka plugins.
* [Our community forum on wp.org](https://wordpress.org/support/plugin/gdpr-cookie-consent/) which is available for all WPLP Cookie Consent users.
