...
class Test_Gdpr_Cookie_Consent_Admin extends WP_UnitTestCase{
    ...
    public function test_add_tabs(){
        ...
        self::$gdpr_cookie_consent->add_tabs();
        // global $hook_suffix;
        // $wp_screen=WP_Screen::get($hook_suffix);
        // self::$gdpr_cookie_consent->add_tabs();
        // $help_tabs=$wp_screen->get_help_tabs();
        // fwrite(STDOUT,print_r($help_tabs));
        // $this->assertEquals('dfd',json_encode($help_tabs));
		// $this->assertArrayHasKey( 'gdprcookieconsent_shortcodes', $help_tabs );
    ...
    public function test_admin_footer_text(){
        $footer="Test";
        // self::$gdpr_cookie_consent->admin_footer_text($footer);
    ...
    public function test_gdpr_getting_started(){
        ...
        fwrite(STDOUT,print_r($en_styles));
		$this->assertArrayHasKey( 'gdpr_cookie_consent', $en_styles );   
    }

    /**
     * Test for gdpr_register_block_type function.
     */
    // public function test_gdpr_register_block_type(){
    //     self::$gdpr_cookie_consent->gdpr_register_block_type();
    //     $this->assertTrue(true);
    // }
    ...
    public function test_gdpr_policies_import_page(){
        try{self::$gdpr_cookie_consent->gdpr_policies_import_page();
        }catch(Exception $e){
            unset($e);
            $this->assertTrue(true);
        }
