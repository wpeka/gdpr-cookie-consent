...
class DesignSettings
{
    ...
    public $borderStyle = '#vs13__combobox > div.vs__selected-options > input';
    public $borderStyleValue = '#vs13__option-2';
    ...
    public $showAsOptionForAcceptBtn = '#vs14__combobox > div.vs__selected-options > input';
    public $showAsOptionForAcceptBtnValue = '#vs14__option-1';
    public $showAsOptionForAcceptBtnValue2 = '#vs14__option-0';
    ...
    public $borderStyleAcceptBtn = '#vs18__combobox > div.vs__selected-options > input';
    public $borderStyleAcceptBtnValue = '#vs18__option-4';
    ...
    public $btnSizeAcceptBtn = '#vs17__combobox > div.vs__selected-options > input';
    public $btnSizeAcceptBtnValue = '#vs17__option-1';
    public $actionAcceptBtn = '#vs15__combobox > div.vs__selected-options > input';
    public $actionAcceptBtnValue = '#vs15__option-0';
    public $actionAcceptBtnValue2 = '#vs15__option-1';
    public $acceptBtn = '#cookie_action_accept';
    public $openUrlInNewWindow = '#vs16__combobox > div.vs__selected-options > input';
    public $openUrlInNewWindowValue = '#vs16__option-0';
    public $openUrlInNewWindowValue2 = '#vs16__option-1';
    ...
    public $showAsOptionForAcceptAllBtn = '#vs19__combobox > div.vs__selected-options > input';
    public $showAsOptionForAcceptAllBtnValue = '#vs19__option-1';
    public $showAsOptionForAcceptAllBtnValue2 = '#vs19__option-0';
    ...
    public $borderStyleAcceptAllBtn = '#vs23__combobox > div.vs__selected-options > input';
    public $borderStyleAcceptAllBtnValue = '#vs23__option-4';
    ...
    public $btnSizeAcceptAllBtn = '#vs22__combobox > div.vs__selected-options > input';
    public $btnSizeAcceptAllBtnValue = '#vs22__option-1';
    public $actionAcceptAllBtn = '#vs20__combobox > div.vs__selected-options > input';
    public $actionAcceptAllBtnValue = '#vs20__option-0';
    public $actionAcceptAllBtnValue2 = '#vs20__option-1';
    public $acceptAllBtn = '#cookie_action_accept_all';
    public $openUrlInNewWindowForAcceptAllBtn = '#vs21__combobox > div.vs__selected-options > input';
    public $openUrlInNewWindowForAcceptAllBtnValue = '#vs21__option-0';
    public $openUrlInNewWindowForAcceptAllBtnValue2 = '#vs21__option-1'; 
    ...
    public $showAsOptionForDeclineBtn = '#vs24__combobox > div.vs__selected-options > input';
    public $showAsOptionForDeclineBtnValue = '#vs24__option-1';
    public $showAsOptionForDeclineBtnValue2 = '#vs24__option-0';
    ...
    public $borderStyleDeclineBtn = '#vs28__combobox > div.vs__selected-options > input';
    public $borderStyleDeclineBtnValue = '#vs28__option-4';
    ...
    public $btnSizeDeclineBtn = '#vs27__combobox > div.vs__selected-options > input';
    public $btnSizeDeclineBtnValue = '#vs27__option-1';
    public $actionDeclineBtn = '#vs25__combobox > div.vs__selected-options > input';
    public $actionDeclineBtnValue = '#vs25__option-0';
    public $actionDeclineBtnValue2 = '#vs25__option-1';
    public $declineBtn = '#cookie_action_reject';
    public $openUrlInNewWindowForDeclineBtn = '#vs26__combobox > div.vs__selected-options > input';
    public $openUrlInNewWindowForDeclineBtnValue = '#vs26__option-0';
    public $openUrlInNewWindowForDeclineBtnValue2 = '#vs26__option-1';
    ...
    public $showAsOptionForSettingsBtn = '#vs29__combobox > div.vs__selected-options > input';
    public $showAsOptionForSettingsBtnValue = '#vs29__option-1';
    public $showAsOptionForSettingsBtnValue2 = '#vs29__option-0';
