...
var gen = new Vue({
    ...
    data() {
        return {	
			data: [
				{ date: '2024-09-01', accept_log: 10, decline_log: 5, partially_acc_log: 3, bypassed_consent_log: 2 },
				{ date: '2024-09-02', accept_log: 7, decline_log: 6, partially_acc_log: 4, bypassed_consent_log: 1 },
				// More data points...
			],
			...
			chartOptions: {
				...
				labels: ['Accepted', 'Rejected', 'Partially Accepted','Bypassed Consent'],
